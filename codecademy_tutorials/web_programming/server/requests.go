...
var reviews = []Review{
	{Name: "Abhisekt Kumar", Dish: "Spaghetti Carbonara", Rating: 5, Comments:"Absolutely delicious! The best Carbonara I've ever had."},
...
func handleData(w http.ResponseWriter, r *http.Request) {
	...
	err := json.NewEncoder(w).Encode(menuItem)
	if err != nil {
